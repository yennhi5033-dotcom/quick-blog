...
export const Signup = () => {
    // 1. State: email, username, password, loading, error
    ...
    // 2. Xử lý khi submit form Signup
    const handleSignup = async (e) => {
        ...
        try {
            ...
            // Sau khi đăng ký thành công, chuyển hướng người dùng đến trang Login
    ...
    return (
        <div>
            <main className="grid min-h-screen place-items-center bg-[linear-gradient(120deg,#070724_0%,#5947f0_48%,#05c7df_100%)] px-4 py-10">
                <form className="w-full max-w-md rounded-lg bg-white p-8 shadow-xl" onSubmit={handleSignup}>
                    <img
                        alt="QuickBlog"
